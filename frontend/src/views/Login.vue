...
const docToc = [
  { id: 's1', label: '第1章 系统概述', level: 0 },
  { id: 's2', label: '第2章 家庭用户操作指南', level: 0 },
  { id: 's3', label: '第3章 管理员操作指南', level: 0 },
  { id: 's4', label: '第4章 算法与数据说明', level: 0 },
  { id: 's5', label: '第5章 常见问题（FAQ）', level: 0 },
]
